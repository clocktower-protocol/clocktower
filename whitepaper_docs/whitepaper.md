...
The Clocktower system begins with a provider determining some basic parameters of a paid web service they would like to provide a fixed interval (weekly, monthly, yearly, etc)

 actually begins off-chain with an agreement between the subscriber and the content or service provider (henceforth "provider"). The most common form of signup would be through a website. This front-end could be custom-build by the provider or a reusable code snippet provided by a third party Clocktower developer. Through this front-end, a subscriber would choose their product, plan, 
