...
As services on the web proliferate, subscription payment systems have become an important source of recurring revenue for many types of digital content. Centralized payment providers have reduced the initial friction of payments on the web, and have made traditional forms of payment (credit/debit/bank transfer) commonplace and straight-forward. However, this convenience comes at a price--online service providers commonly pay more than 3% for this functionality (reference) and these costs are passed to the consumer. Payment platforms have become the front-line for censorship of people and ideas on the web, inspiring some to [leave popular crowdfunding platorms in favor of their own platforms](https://www.businessinsider.com/sam-harris-deletes-patreon-account-after-platform-boots-conservatives-2018-12). While the major payment networks have generally not taken an activist role in online political speech, they remain a critical threat to free speech and an open internet.

A possible solution lies outside the traditional payment system in the realm of cryptocurrency. Ethereum's decentralized network and stablecoins could, in theory, be used to make recurring payments to content creators and other service providers, but there are technical challenges to overcome. One of the main limitations of decentralized smart contracts is that they must be acted upon by outside users. This makes it impossible to schedule any actions in the future, as with a cron job in normal computing. Without the ability to schedule transactions in the future, commonplace financial services like payroll, subscriptions, regular payments, and many others become impossible or overly complicated. 
